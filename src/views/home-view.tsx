...
import { View, StyleSheet, Animated, RefreshControl, Text } from 'react-native';
  ...
  const dateFilteredMovements = useMemo(() => {
    return movements.filter((m) => {
      ...
      const accountMatches =
        selectedAccount === 'All' || m.transactions.some((t) => t.account === selectedAccount);
