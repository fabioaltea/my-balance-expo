      ...
      <View style={styles.content}>
            ...
            <View style={styles.errorContainer}>
              <View style={[styles.errorContent]}>
                <View style={styles.errorHeader}>
                  ...
                  <TouchableOpacity onPress={handleDismissError} style={styles.errorCloseButton}>
        ...
        <View style={styles.features}>
          <View style={styles.feature}>
            <Ionicons name="shield-checkmark" size={24} color="rgba(255,255,255,0.8)" />
            <Text style={styles.featureText}>Your data stays in Google Sheets</Text>
          </View>
          <View style={styles.feature}>
