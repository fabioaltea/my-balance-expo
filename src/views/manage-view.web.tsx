...
const ManageView: React.FC<ManageViewProps> = ({ onBack }) => {
  ...
  return (
    <View style={[styles.container, { backgroundColor }]}>
            ...
            {accounts.length === 0 ? (
              ...
              accounts.map((account) => (
                ...
                >
                  ...
                  <ThemedText style={styles.chipValue}>{formatCurrency(account.balance)}</ThemedText>
                </Pressable>
              ))
            )}
          </View>
      ...
      <SideDrawer isOpen={accountDrawerOpen} onClose={() => setAccountDrawerOpen(false)} width="35%">
